...
public class MediaController extends FrameLayout {
	...
	private void disableUnsupportedButtons() {
		try {
			...
			if (mProgress != null && !mPlayer.canSeekBar()) {
	...
	public void show(int timeout) {
		if (!mPlayer.canShowMediaController()) {
			return;
		}
		
		if (mPlayer != null) {
			mPlayer.showControllExtra();
		}
	...
	public interface MediaPlayerControl {
		...
		boolean canShowMediaController();
		
		void showControllExtra();
		
		void hideControllExtra();
	}
