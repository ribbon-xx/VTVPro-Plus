...
//						if (mMediaFunctionExtra != null) {
//							mMediaFunctionExtra.show();
//						}
					} else if (!isPlaying()
...
//			}
	...
	private MediaFunctionExtra mMediaFunctionExtra;
...
//			}
	...
	public void setMediaFunctionExtra(MediaFunctionExtra controller) {
		if (mMediaFunctionExtra != null) {
			mMediaFunctionExtra.hide();
		}
		mMediaFunctionExtra = controller;
	}
...
//		}
	...
	public boolean canSeekBar() {
		return (!this.mIsChannel);
	}

	@Override
	public boolean canShowMediaController() {
		// TODO Auto-generated method stub
		return this.mShowMediaController;
	}
	
	@Override
	public void showControllExtra() {
		// TODO Auto-generated method stub
		if (mMediaFunctionExtra != null) {
			mMediaFunctionExtra.show();
		}
	...
	public void setShowMediaController(boolean isShow) {
		this.mShowMediaController = isShow;
	}
	 ...
	 * 
	 ************************************************************/
	public interface MediaFunctionExtra {
		public void show();
		public void hide();
	}
}
