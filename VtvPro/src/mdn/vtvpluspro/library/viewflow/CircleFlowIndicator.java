 ...
 */
package mdn.vtvpluspro.library.viewflow;
...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// Retrieve the radius
		radius = a.getDimension(R.styleable.CircleFlowIndicator_radius1, 6.0f);

		// Retrieve the fade out time
		fadeOutTime = a.getInt(R.styleable.CircleFlowIndicator_fadeOut, 1000);
