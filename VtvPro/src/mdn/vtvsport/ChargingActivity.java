...
import mdn.vtvsport.object.ChargingSMSInfo;
...
import mdn.vtvsport.util.SmsUtil;
...
//	}
	...
	private void login(final String userName, final String password) {
		callLoginApi(new IApiCallback() {
			...
			@Override
			public void responseSuccess(String response) {
				mdn.vtvsport.object.account.UserInfo info = ParserManager.parserLoginInfo(response);
				if (info.isGetSucc()) {
